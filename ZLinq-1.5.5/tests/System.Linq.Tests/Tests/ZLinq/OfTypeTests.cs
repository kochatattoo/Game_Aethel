...
namespace ZLinq.Tests
{
    public class OfTypeTests : EnumerableTests
    {
        ...
        {
            IEnumerable<object> source = [1, 2, 3, 4, 5];
            Assert.Equal([1, 2, 3, 4, 5], source.OfType<int>().ToList());
        ...
        public void MultiDimArray_OfType_Succeeds()
        {
            ...
            {
                Assert.Contains(s, array.OfType<string>());
            }
        }
        ...
        public void OfType_Contains_FiltersByTypeEvenIfEqual()
        {
            ...
            Assert.DoesNotContain(new MySneakyObject2(), list.OfType<MySneakyObject2>());
        }
