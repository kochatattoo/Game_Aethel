    ...
    public class AverageTests : EnumerableTests
    {
        ...
        public static IEnumerable<object[]> Int_TestData()
        {
            ...
            for (int i = 1; i <= 33; i++)
            {
                ...
                yield return [Enumerable.Range(1, i).Shuffle().ToArray(), expected];
            }
        }
        ...
        public static IEnumerable<object[]> Long_TestData()
        {
            ...
            for (int i = 1; i <= 33; i++)
            {
                ...
                yield return [Enumerable.Range(1, i).Select(i => (long)i).Shuffle().ToArray(), expected];
            }
        }
        ...
        public static IEnumerable<object[]> Double_TestData()
        {
            ...
            for (int i = 1; i <= 33; i++)
            {
                ...
                yield return [Enumerable.Range(1, i).Select(i => (double)i).Shuffle().ToArray(), expected];
            }
        }
        ...
        public static IEnumerable<object[]> Decimal_TestData()
        {
            ...
            for (int i = 1; i <= 33; i++)
            {
                ...
                yield return [Enumerable.Range(1, i).Select(i => (decimal)i).Shuffle().ToArray(), expected];
            }
        }
        ...
        public static IEnumerable<object[]> Float_TestData()
        {
            ...
            for (int i = 1; i <= 33; i++)
            {
                ...
                yield return [Enumerable.Range(1, i).Select(i => (float)i).Shuffle().ToArray(), expected];
            }
        }
