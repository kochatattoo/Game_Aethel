...
namespace ZLinq.Tests
{
    public class RightJoinTests : EnumerableTests
    {
        ...
        public void OuterNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>(() => outer.RightJoin(inner, e => e.name, e => e.name, createJoinRec, new AnagramEqualityComparer()));
        }
        ...
        public void OuterNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>(() => outer.RightJoin(inner, e => e.name, e => e.name, createJoinRec));
        }
        ...
        {
            var valueEnumerable = NumberRangeGuaranteedNotCollectionType(0, 3).RightJoin(Enumerable.Empty<int>(), i => i, i => i, (o, i) => i);
