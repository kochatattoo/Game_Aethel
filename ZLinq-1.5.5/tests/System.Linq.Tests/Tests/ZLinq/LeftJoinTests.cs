...
namespace ZLinq.Tests
{
    public class LeftJoinTests : EnumerableTests
    {
        ...
        public void OuterNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>(() => outer.LeftJoin(inner, e => e.name, e => e.name, createJoinRec, new AnagramEqualityComparer()));
        }
        ...
        public void OuterNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>(() => outer.LeftJoin(inner, e => e.name, e => e.name, createJoinRec));
        }
        ...
        public void SelectorsReturnNull()
        {
            ...
            Assert.Equal(expected, outer.LeftJoin(inner, e => e, e => e, (x, y) => y));
        }
        ...
        {
            var valueEnumerable = NumberRangeGuaranteedNotCollectionType(0, 3).LeftJoin(Enumerable.Empty<int>(), i => i, i => i, (o, i) => i);
