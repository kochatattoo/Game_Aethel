...
internal static partial class ZLinqDropInExtensions
{
 ...
 => source.AsValueEnumerable().Concat(second);
    ...
    public static Int32 CopyTo<TSource>(this TSource[] source, Span<TSource> destination) => source.AsValueEnumerable().CopyTo(destination);
    public static void CopyTo<TSource>(this TSource[] source, List<TSource> list) => source.AsValueEnumerable().CopyTo(list);
 ...
 => source.AsValueEnumerable().GroupJoin(inner, outerKeySelector, innerKeySelector, resultSelector, comparer);
    ...
    public static ValueEnumerable<Index<FromArray<TSource>, TSource>, (int Index, TSource Item)> Index<TSource>(this TSource[] source) => source.AsValueEnumerable().Index();
 ...
 => source.AsValueEnumerable().Join(inner, outerKeySelector, innerKeySelector, resultSelector, comparer);
    ...
    public static String JoinToString<TSource>(this TSource[] source, String separator) => source.AsValueEnumerable().JoinToString(separator);
    public static String JoinToString<TSource>(this TSource[] source, Char separator) => source.AsValueEnumerable().JoinToString(separator);
    public static String JoinToString<TSource>(this TSource[] source, ReadOnlySpan<Char> separator) => source.AsValueEnumerable().JoinToString(separator);
 ...
 => source.AsValueEnumerable().RightJoin(inner, outerKeySelector, innerKeySelector, resultSelector, comparer);
    ...
    public static ValueEnumerable<ArraySelect<TSource, TResult>, TResult> Select<TSource, TResult>(this TSource[] source, Func<TSource, TResult> selector) => source.AsValueEnumerable().Select(selector);
 ...
 => source.AsValueEnumerable().UnionBy(second, keySelector, comparer);
    ...
    public static ValueEnumerable<ArrayWhere<TSource>, TSource> Where<TSource>(this TSource[] source, Func<TSource, Boolean> predicate) => source.AsValueEnumerable().Where(predicate);
 ...
 => source.AsValueEnumerable().Zip(second, resultSelector);
    public static ValueEnumerable<Zip<FromArray<TFirst>, FromEnumerable<TSecond>, TFirst, TSecond>, (TFirst First, TSecond Second)> Zip<TFirst, TSecond>(this TFirst[] source, IEnumerable<TSecond> second) => source.AsValueEnumerable().Zip(second);
    public static ValueEnumerable<Zip<FromArray<TFirst>, FromEnumerable<TSecond>, FromEnumerable<TThird>, TFirst, TSecond, TThird>, (TFirst First, TSecond Second, TThird Third)> Zip<TFirst, TSecond, TThird>(this TFirst[] source, IEnumerable<TSecond> second, IEnumerable<TThird> third) => source.AsValueEnumerable().Zip(second, third);
