...
namespace Infrastructure.AudioSystem.Parameters
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = nameof(AudioDatabase), menuName = ScriptableObjectAudioNames.AudioMenu + nameof(AudioDatabase))]
    public class AudioDatabase : ScriptableObject
    {
        ...
        // TODO: Подумать над тем, что бы хранить и передавать тут другие конфиги (такие как SurfaceResolver) 
        // Например:
        //[field: SerializeField]
        //public BaseSurfaceResolverConfig<AK.Wwise.Switch> SurfaceResolverConfig { get; private set; }
    }
}
