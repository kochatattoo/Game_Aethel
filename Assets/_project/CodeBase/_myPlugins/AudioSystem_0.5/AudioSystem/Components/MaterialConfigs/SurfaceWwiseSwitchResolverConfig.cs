...
namespace Infrastructure.AudioSystem.Components.MaterialConfigs
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = nameof(SurfaceWwiseSwitchResolverConfig), menuName = ScriptableObjectAudioNames.AudioMenu + nameof(SurfaceWwiseSwitchResolverConfig))]
